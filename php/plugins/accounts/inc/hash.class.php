...
class PluginAccountsHash extends CommonDBTM {
   ...
   public function showForm ($ID, $options=array()) {
      ...
      if($ID < 1 && countElementsInTable("glpi_plugin_accounts_hashes",$restrict) > 0) {
         echo "<div class='center red'>".__('WARNING : a encryption key already exist for this entity', 'accounts')."</div></br>";
      }
      ...
      if (!$options['upgrade'] && $options['update']==1) {
         echo "<div class='center red'>".__('Warning : if you change used hash, the old accounts will use the old encryption key', 'accounts').
         "</font><br><br>";
      }
