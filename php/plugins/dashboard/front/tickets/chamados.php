...
?>
<!-- <div id="hora" style="align:right; position:absolute;"><form name="clock"><input type="text" name="face" value="" size=15 style="font-size:20pt; height:40px; border:0px; " ></form> </div> -->
