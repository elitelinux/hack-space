...
xgettext *.php */*.php --copyright-holder='Utilitaires Development Team' --package-name='GLPI - utilitaires plugin' --package-version='1.6.0' -o locales/glpi.pot -L PHP --add-comments=TRANS --from-code=UTF-8 --force-po  \
