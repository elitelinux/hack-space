...
class PluginManufacturersimportsConfig extends CommonDBTM {
   ...
   function getTabNameForItem(CommonGLPI $item, $withtemplate=0) {
      ...
      if (in_array($item->getType(), self::getTypes(true))
              && plugin_manufacturersimports_haveRight('manufacturersimports', 'r')
	...
	function post_addItem() {
		...
		if ($this->fields["is_recursive"]) {
			$query="DELETE FROM `".$this->getTable()."`
					...
					getEntitiesRestrictRequest('AND',$this->getTable(),'',getSonsOf("glpi_entities",$this->fields["entities_id"]));
   ...
   static function getSuppliers() {
      ...
      $options["Dell"] = "Dell";
      $options["HP"] = "HP";
      $options["Fujitsu"] = "Fujitsu";
      $options["Toshiba"] = "Toshiba";
      $options["Lenovo"] = "Lenovo";
      return $options;
   }
   ...
   function getSearchOptions() {
      ...
      $tab[3]['name']            = __('Manufacturer web address', 'manufacturersimports');
      $tab[3]['datatype']        = 'weblink';
      $tab[3]['massiveaction']   = false;
      
      $tab[4]['table']           = 'glpi_suppliers';
      $tab[4]['field']           =  'name';
      $tab[4]['name']            =  __('Default supplier attached', 'manufacturersimports');
      $tab[4]['datatype']        = 'dropdown';
      
      $tab[5]['table']           = $this->getTable();
      $tab[5]['field']           = 'warranty_duration';
      $tab[5]['name']            = __('New warranty attached', 'manufacturersimports');
      $tab[5]['datatype']        = 'integer';
      $tab[5]['massiveaction']   = false;
      
      $tab[6]['table']           = $this->getTable();
      $tab[6]['field']           = 'document_adding';
      $tab[6]['name']            = __('Auto add of document', 'manufacturersimports');
      $tab[6]['datatype']        = 'bool';
      ...
      $tab[8]['name']            = __('Add a comment line', 'manufacturersimports');
      $tab[8]['datatype']        = 'bool';
	...
	function showForm ($ID, $options=array()) {
      ...
      Ajax::updateItemOnSelectEvent("dropdown_supplier$rand", "show_preconfig",
