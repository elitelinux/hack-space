...
function plugin_typology_uninstall() {
   ...
   $tables = array( "glpi_plugin_typology_profiles",
...
function plugin_typology_postinit() {
   ...
   $PLUGIN_HOOKS['pre_item_purge']['typology'] = array('Profile'=>array(
      'PluginTypologyProfile', 'purgeProfiles'));
...
function plugin_typology_getDatabaseRelations() {
   ...
   if ($plugin->isActivated("typology"))
      return array ("glpi_profiles" => array ("glpi_plugin_typology_profiles" => "profiles_id"),
                    "glpi_entities" => array ("glpi_plugin_typology_typologies" =>"entities_id",
...
//         // Action for typology
//         return array(
//            "plugin_typology_transfert" => __('Transfer'),
//            "plugin_typology_duplicate" => _sx('button','Duplicate'));
//         break;
      default:
...
function plugin_typology_getAddSearchOptions($itemtype) {
   ...
   if ($plugin->isActivated('typology')
         && plugin_typology_haveRight("typology","r")) {
