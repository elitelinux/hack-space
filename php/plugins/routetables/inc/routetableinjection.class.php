...
/// Computer class
class PluginRoutetablesRoutetableInjection extends PluginRoutetablesRoutetable
   ...
   function getOptions($primary_type = '') {
      ...
      $notimportable = array(9,30,80);
      $options['ignore_fields'] = $notimportable;
      $options['displaytype'] = array("multiline_text" => array(8),
                                      "bool"           => array(7,10));
