...
function plugin_resources_getDropdown() {
   ...
   if ($plugin->isActivated("resources")) {
      return array('PluginResourcesContractType'        => PluginResourcesContractType::getTypeName(2),
                     ...
                     'PluginResourcesResourceState'      => PluginResourcesResource::getTypeName(2).
                     ...
                     'PluginResourcesResourceSituation'  => PluginResourcesEmployer::getTypeName(2).
                                                               " - ".PluginResourcesResourceSituation::getTypeName(2),
...
function plugin_resources_MassiveActions($type) {
   ...
   if (in_array($type, PluginResourcesResource::getTypes())) {
      return array(  "plugin_resources_add_item"=>__('Associate a resource', 'resources'),
                     "plugin_resources_generate_resources"=> __('Generate resources', 'resources')
                  );
   }
   return array();
}
               ...
               if (!isset($resource->fields['id']) || $resource->fields['id'] <= 0){
                  ...
                  if ($resourceItem->can(-1,'w',$input)) {
                     ...
                     if ($idResource){
                        ...
                        if (isset($resourceItem->fields['id'])) unset($resourceItem->fields['id']);
